...
<table style="width:100%">
  ...
  <tr>
    ...
    <td>1</td>
    <td><input type="hidden" name="u_id" value="<%= u_id %>"><%= u_id %> </td>
    <td><input type="hidden" name="u_level" value="<%= u_level %>"><%= u_level %></td>
    <td><input type="hidden" name="u_name" value="<%= u_name %>"><%= u_name %></td>
    <td><input type="hidden" name="u_email" value="<%= u_email %>"><%= u_email %></td>
    <td><input type="hidden" name="u_pw" value="<%= u_pw %>">
