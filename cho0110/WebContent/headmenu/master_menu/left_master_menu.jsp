 ...
 <!-- LEFT-CONTAINER -->
            <div class="left-container container">
                <div class="menu-box block"> <!-- MENU BOX (LEFT-CONTAINER) -->
                    <h2 class="titular">관리자 메뉴</h2>
                    <ul class="menu-box-menu">
                        <li>
                            <a class="menu-box-tab" href="<%=request.getContextPath()%>/headmenu/master_menu/user_list.jsp"><span class="icon fontawesome-envelope scnd-font-color"></span>회원관리</a>                            
                        </li>
                        <li>
                            <a class="menu-box-tab" href="#8"><span class="icon entypo-paper-plane scnd-font-color"></span>깨짐<div class="menu-box-number">3</div></a>                            
                        </li>
                        <li>
                            <a class="menu-box-tab" href="#10"><span class="icon entypo-calendar scnd-font-color"></span>테스트<div class="menu-box-number">5</div></a>                            
                        </li>
                        <li>
                            <a class="menu-box-tab" href="#12"><span class="icon entypo-cog scnd-font-color"></span>문자</a>
                        </li>
                        <li>
                            <a class="menu-box-tab" href="#13"><sapn class="icon entypo-chart-line scnd-font-color"></sapn>메뉴</a>
                        </li>                        
                    </ul>
                </div>
